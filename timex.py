...
def hasTime(text):
    import nltk
    text = 'Barack Hussein Obama II, born on August 4, is the 44th and current President of the United States, as well as the first African American to hold the office. '.lower()
    text = "He was born on August 2, 1951"
    print tag(text)
    if "<TIMEX2>" in tag(text):
        return True
    else:
        return False
